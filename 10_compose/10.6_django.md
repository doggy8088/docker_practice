...
### Step 3: 建立 compose.yaml

Step 3: 建立 `compose.yaml` 設定如下：
...
- [Compose 樣板檔案詳解](10.5_compose_file.md)：深入理解 Compose 檔案的所有設定項
- [使用 WordPress](10.8_wordpress.md)：另一個 Compose 實戰案例
- [Dockerfile 最佳實踐](../16_appendix/16.1_best_practices.md)：建立更小、更安全的映象
