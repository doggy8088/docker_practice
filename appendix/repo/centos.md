...
> - [CentOS Stream](https://quay.io/repository/centos/centos)：RHEL 的上游開發分支，映象已遷移至 Quay.io (適合開發測試，不建議用於生產環境)。

該倉庫位於 [Docker Hub 的 CentOS 官方映象頁](https://hub.docker.com/_/centos)，提供了 CentOS 從 5 ~ 8 各個版本的映象（僅作為歷史歸檔，不再更新）。
...
請到 [CentOS 官方映象文件目錄](https://github.com/docker-library/docs/tree/master/centos) 檢視。
