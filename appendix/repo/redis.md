...
該倉庫位於 [Docker Hub 的 Redis 官方映象頁](https://hub.docker.com/_/redis/)。具體可用版本以 Docker Hub 上的 tags 清單為準。
...
請到 [Redis 官方映象文件目錄](https://github.com/docker-library/docs/tree/master/redis) 檢視。
