...
更多內容請檢視 [Dockerfile 最佳實踐](../20.1_best_practices.md)
...
答：一般並不推薦在同一個容器內執行多個應用程序。如果有類似需求，可以透過一些額外的程序管理機制，比如 `supervisord` 來管理所執行的程序。可以參考 https://docs.docker.com/engine/containers/multi-service_container/ 。
