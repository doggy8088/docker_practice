...
> **版本說明**：本節範例基於 Docker v29.x 和常見映象版本編寫。範例中的版本號（如 `nginx:1.28`、`mysql:8.0`、`mysql:5.7` 等）為示範用途。實際使用時請訪問 [Docker Hub 官方頁面](https://hub.docker.com) 或相應映象的發布頁確認最新可用版本和標籤。
