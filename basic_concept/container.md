...
| **[繫結掛載（Bind Mount）](../data_management/bind-mounts.md)** | 掛載宿主機目錄 | 開發時共享程式碼 |
...
詳細解釋請參考[後台執行](../container/daemon.md)章節。
...
> 想深入瞭解？請閱讀[底層實現 - 命名空間](../underly/namespace.md)。
...
- [啟動容器](../container/run.md)：詳細的容器啟動選項
- [後台執行](../container/daemon.md)：理解容器為什麼會"立即退出"
- [進入容器](../container/attach_exec.md)：如何操作執行中的容器
