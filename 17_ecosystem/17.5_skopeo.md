...
> **版本說明**：Skopeo 與 Podman、Buildah 同屬 `podman-container-tools` 專案生態。建議訪問 [Skopeo 官方倉庫](https://github.com/podman-container-tools/skopeo) 和 [GitHub Releases](https://github.com/podman-container-tools/skopeo/releases) 獲取最新版本訊息。
...
```
如果我們要將本地的某個目錄下的打包好的映象再次推向 Registry 或轉換為其他儲存型別也是完全支援的，諸如：
