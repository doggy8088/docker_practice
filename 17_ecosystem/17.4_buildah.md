...
> **版本說明**：Buildah 與 Podman 和 Skopeo 共同維護。建議查閱 [Buildah 官方文件](https://buildah.io/) 和 [GitHub Releases](https://github.com/podman-container-tools/buildah/releases) 瞭解最新版本。
