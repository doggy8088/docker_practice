...
> **版本說明**：Kata Containers、gVisor 和 Firecracker 均為活躍開發的專案。建議查閱各項目官方文件獲取最新版本和相容性訊息：[Kata Containers](https://katacontainers.io/)、[gVisor](https://gvisor.dev/)、[Firecracker](https://firecracker-microvm.github.io/)。
