...
> **版本說明**：Podman 保持活躍的開發和發布週期。建議訪問 [Podman 官方文件](https://podman.io/docs) 和 [GitHub Releases](https://github.com/podman-container-tools/podman/releases) 獲取最新版本。

[Podman](https://github.com/podman-container-tools/podman) 是一個無守護程序、與 Docker 指令高度相容的下一代 Linux 容器工具。它由 Red Hat 開發，旨在提供一個更安全的容器執行環境。
