...
- containerd 2.0 移除了已棄用的 CRI v1alpha2 介面，僅保留 CRI v1（Kubernetes 自 v1.26 起僅支援 CRI v1）。如果叢集中仍有依賴 CRI v1alpha2 的元件，升級 containerd 2.x 前需先完成遷移。containerd 2.3（2026 年 4 月）是 2.x 系列首個 LTS 版本，支援從 1.7 LTS 直接升級，生產環境推薦使用。
