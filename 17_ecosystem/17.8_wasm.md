...
> **版本說明**：WebAssembly 和相關的 Wasm 執行時（如 WasmEdge、Spin）處於快速演進階段。建議查閱 [WebAssembly 官方文件](https://webassembly.org/)、[WasmEdge](https://wasmedge.org/) 和 [Spin](https://developer.fermyon.com/spin) 官方文件獲取最新訊息。
