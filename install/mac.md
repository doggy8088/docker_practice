...
[Docker Desktop for Mac](https://docs.docker.com/docker-for-mac/) 要求系統最低為 macOS Sonora 14.0 或更高版本，建議升級到最新版本的 macOS。
...
> 如果你的電腦搭載的是 Apple Silicon 晶片（`arm64` 架構），請點選以下 [連結](https://desktop.docker.com/mac/main/arm64/Docker.dmg) 下載 Docker Desktop for Mac。你可以在 [官方文件](https://docs.docker.com/docker-for-mac/apple-silicon/) 查閱已知的問題。
