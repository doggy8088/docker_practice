...
Docker 支援 64 位版本 CentOS 7/8/9（Stream）、Rocky Linux 8/9、AlmaLinux 8/9，並且要求核心版本不低於 3.10。CentOS 7 滿足最低核心的要求，但由於核心版本比較低，部分功能（如 `overlay2` 儲存層驅動）無法使用，並且部分功能可能不太穩定。
