...
> **版本說明**：使用 `httpd:2.4-alpine` 基於 Apache 2.4 的精簡映象。如需其他版本，可替換為 `httpd:latest` 或指定具體版本號如 `httpd:2.4.58-alpine`。
...
> **版本說明**：範例使用 `ubuntu:24.04`，這是最新 LTS 版本。推送到私有倉庫時保持了原有的版本標籤，建議生產環境明確指定映象版本號。
如果我們退出登入，嘗試推送映象。
