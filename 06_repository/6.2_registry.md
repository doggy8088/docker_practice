...
[Docker Registry](https://docs.docker.com/registry/) 是官方提供的工具，可以用於建立私有的映象倉庫。本文內容基於 [distribution/distribution](https://github.com/distribution/distribution) v2.x 版本。
