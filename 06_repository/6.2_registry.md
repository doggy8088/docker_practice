...
[Docker Registry](https://docs.docker.com/registry/) 是官方提供的工具，可以用於建立私有的映象倉庫。本文範例沿用 [distribution/distribution](https://github.com/distribution/distribution) v2.x 相容路徑；新生產部署應評估 Distribution 3.x，並核對設定路徑、遷移說明和生態相容性。
