...
- **程式語言映象** (`golang:1.26-alpine`、`rust:1.95-alpine` 等) 採用次版本標籤，確保 API 穩定性同時獲得安全更新
- **資料庫映象** (`postgres:16-alpine`、`redis:8-alpine` 等) 採用大版本標籤，便於獲得修復和改進
- **基礎映象** (`alpine:3.21`、`debian:12` 等) 採用大版本或次版本標籤，避免 `latest` 以確保可再現性
