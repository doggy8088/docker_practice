...
開啟我們已經 [部署好的 Drone 網站](10.2_install.md) 或者 [Drone Cloud](https://cloud.drone.io)，使用 GitHub 賬號登入，在介面中關聯剛剛新建的 `drone-demo` 倉庫。
...
本書 GitBook 也使用 Drone 進行 CI/CD，具體設定訊息請檢視本書根目錄 [`.drone.yml`](../../../.drone.yml) 檔案。
