...
- **Alpine、Debian、Ubuntu、CentOS** 等作業系統映象採用大版本或次版本標籤（如 `alpine:3.21`、`ubuntu:26.04`），避免使用 `latest` 標籤確保建立的可再現性
...
- **通用映象** (Debian、Ubuntu) - 提供完整的 Linux 功能和豐富的軟體生態，映象大小通常在 80-300 MB 之間。適合需要靈活安裝各種依賴和工具的應用場景。
