...
Docker 預設啟用了 Seccomp 並利用預置的 [預設設定檔案](https://github.com/moby/moby/blob/master/profiles/seccomp/default.json) 將可以利用的系統呼叫縮減到了不足一半（預設停用了 44 個危險的系統呼叫，比如修改時區或重啟系統）。
