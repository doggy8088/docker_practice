...
> **注意：DCT 退役時間線**
>
> Docker 已宣佈[退役 Content Trust](https://www.docker.com/blog/retiring-docker-content-trust/)。關鍵節點：
> - 2025 年 8 月起：最早一批 DCT 簽名證書開始過期
> - 2025 年 9 月 30 日起：新登錄檔不可再啟用 DCT
> - **2028 年 3 月 31 日**：DCT 完全移除，所有 DCT 資料永久刪除
>
> 建議新專案直接使用上文介紹的 **Cosign (Sigstore)** 進行映象簽名；現有 DCT 使用者應儘早制定遷移計劃。

Docker Content Trust 使用 Notary 實現映象簽名，是 Docker 官方的傳統簽名解決方案。
...
jobs:
  build-scan:
    ...
    - name: Run Trivy vulnerability scan
      ...
      # 75 個版本標籤被劫持。務必使用不可變的 commit SHA 引用，而非可變標籤。
