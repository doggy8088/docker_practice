...
Docker 利用 Linux 的能力機制 (Capabilities) 來限制容器的許可權，從而提高系統的安全性。
...
預設情況下，Docker 採用[白名單](https://github.com/moby/moby/blob/master/oci/caps/defaults.go)機制，停用必需功能之外的其它許可權。
