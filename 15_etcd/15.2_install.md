...
> 注意：etcd 官方僅維護最新兩個次版本（當前為 3.5 和 3.6）。etcd 3.4 已於 2026 年 5 月結束支援（EOL），仍在使用 3.4 的使用者應儘快升級。本章範例基於 etcd `3.5.x` 版本編寫。etcd 3.6.x 可用於新部署。請訪問 [etcd 官方發布頁](https://github.com/etcd-io/etcd/releases) 獲取最新版本。
