...
> 注意：etcd 官方僅維護最新兩個次版本（2026 年 7 月 etcd 3.7.0 發布後為 3.6 和 3.7）。etcd 3.4 已於 2026 年 5 月結束支援（EOL），3.5 也已退出維護視窗，仍在使用的使用者應儘快升級。本章範例基於 etcd `3.5.x` 版本編寫，etcd 3.6.x/3.7.x 可用於新部署。請訪問 [etcd 官方發布頁](https://github.com/etcd-io/etcd/releases) 獲取最新版本。
...
> **版本說明：** 範例中使用 `v3.5.29` 標籤。請訪問 [etcd 官方發布頁](https://github.com/etcd-io/etcd/releases) 獲取最新可用版本標籤。
