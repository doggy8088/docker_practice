...
> **版本說明**：Kubernetes 版本更新較快 (約每 4 個月一個新版本)，本文件基於 Kubernetes 1.35 編寫。更完整的安裝和相容性說明請以 [Kubernetes 官方 kubeadm 文件](https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/install-kubeadm/) 和 [containerd 官方文件](https://containerd.io/docs/) 為準。
