...
建立 `compose.yaml` (或 `docker-compose.yml`)。下面範例使用的是 2026 年 4 月的穩定版本。對於生產環境部署，建議查閱 [Prometheus 官方文件](https://prometheus.io/docs/prometheus/latest/installation/) 確認最新推薦版本：
