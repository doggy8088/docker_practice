...
1. 編寫 `compose.yaml` (或 `docker-compose.yml`) 設定如下。**版本提示**：本範例使用 Elasticsearch 9.x、Kibana 9.x、Fluentd 等元件的特定版本號，僅作為參考。生產環境部署前，請查閱 [Elastic 官方文件](https://www.elastic.co/docs/) 和 [Fluentd 官方文件](https://docs.fluentd.org/) 確認最新版本與設定相容性。
