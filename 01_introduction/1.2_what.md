...
**Docker 架構演進**：Docker 的底層實現經歷了多次演進：
...
**Docker** 最初是 `dotCloud` 公司創始人 [Solomon Hykes](https://github.com/shykes) 發起的一個公司內部專案，於 [2013 年 3 月以 Apache 2.0 授權協定開源](https://en.wikipedia.org/wiki/Docker_%28software%29)。
...
- **截至 2026 年 4 月**：[GitHub 專案](https://github.com/moby/moby)超過 7 萬星標
